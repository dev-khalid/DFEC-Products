...
export class InventoryReverseRelation1726494946499
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`product\` ADD \`inventoryId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`product\` ADD UNIQUE INDEX \`IDX_0d5b00db0b857ac0d8c4dd7243\` (\`inventoryId\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_0d5b00db0b857ac0d8c4dd7243\` ON \`product\` (\`inventoryId\`)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`product\` DROP INDEX \`IDX_0d5b00db0b857ac0d8c4dd7243\``,
    );
    await queryRunner.query(
